...
const sttaddr = "0xd61bc941c089962fb07a6E22fA49371517A5a3b2";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0xd61bc941c089962fb07a6E22fA49371517A5a3b2";
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://rubyprotocol.net/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'BEP20',
                'options': {
                    'address': '0xd61bc941c089962fb07a6E22fA49371517A5a3b2',
                    'symbol': 'RUBY',
                    'decimals': '12',
                    'image': 'https://rubyprotocol.net/images/logo.png',
                },
            },
